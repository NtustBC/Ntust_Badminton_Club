const EN_TRANSLATIONS = {
  ...
  "目前登入": "Signed In Now",
  "顯示正式社員與幹部資料；幹部不計入社員申請名額。展開後可修改基本資料、學年度與學期。": "Shows active members and club officers. Officers do not count toward the membership capacity. Expand a row to edit profile and semester details.",
