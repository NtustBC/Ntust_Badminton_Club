const EN_TRANSLATIONS = {
  ...
  "請輸入 FAQ 回答內容": "Enter the FAQ answer",
  ...
  "目前沒有 FAQ": "No FAQs",
  "你可以先用左邊表單新增第一則問答。": "Use the form on the left to add the first FAQ.",
  "刪除 FAQ": "Delete FAQ",
  "目前沒有待處理問題": "No Questions Awaiting a Response",
  "訪客從 FAQ 頁送出問題後，會依序顯示在這裡。": "Questions submitted from the FAQ page appear here in order.",
  "待回答": "Awaiting Response",
  "未填寫問題": "Question Not Provided",
  "輸入回答後會發布到 FAQ": "Enter an answer to publish it to the FAQ",
  "發布回答": "Publish Answer",
  ...
  "FAQ 載入失敗": "FAQ Could Not Be Loaded",
  ...
  "你可以在下方直接管理社員資料、審核報名、安排社課與發布公告或 FAQ，所有內容都會同步到 Firestore。": "Manage member records, review registrations, schedule classes, and publish announcements or FAQs below. All changes synchronize with Firestore.",
  "管理總覽": "Administration Overview",
  "登入管理員後會顯示完整管理內容，包括社員、報名、社課、公告與 FAQ。": "The complete dashboard includes members, registrations, classes, announcements, and FAQs.",
